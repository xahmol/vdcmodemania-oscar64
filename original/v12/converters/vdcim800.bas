    ...
    5 gosub14:printli$:ifli$<>"800 600"thenclose2:stop
    6 gosub14:printli$:ifli$<>"255"thenclose2:stop
    7 print"header ok. press key.{down}{down}":getkeya$
    8 fory=0to599:print"{up}"y+1"{left}/600":forx=0to99
   ...
   20 rem ** adapted for vdc 800x600 2015-01-08 by torsten kracke
