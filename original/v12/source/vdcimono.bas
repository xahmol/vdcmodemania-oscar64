    ...
    5 gosub14:printli$:ifli$<>"720 700"thenclose2:stop
    6 gosub14:printli$:ifli$<>"255"thenclose2:stop
    7 print"header ok. press key.{down}{down}":getkeya$
    8 fory=0to699:print"{up}"y+1"{left}/700":forx=0to89
   ...
   20 rem ** adapted for vdc 720x700 2011-07-28 by torsten kracke
